                ...
                <div class="card-body p-4">
                    ...
                    <div class="tab-content mt-3" id="filterTabsContent">
                        ...
                        <div class="tab-pane fade show active" id="all-reports" role="tabpanel">
                            ...
                            <table class="table table-striped table-hover align-middle">
                                ...
                                <tbody>
                                    ...
                                    @empty
                                        <tr>
                                            <td colspan="8" class="text-center text-muted">Tidak ada laporan tersedia.
                                            </td>
                                        </tr>
                                    @endforelse
                                </tbody>
                        ...
                        <div class="tab-pane fade" id="damaged-facilities" role="tabpanel">
                            <h4 class="mb-3">Fasilitas Rusak (Bulan Tertentu)</h4>
                            <div class="mb-3">
                            ...
                            @if ($damagedFacilities->isEmpty())
                                <p class="text-muted">Tidak ada fasilitas rusak untuk bulan ini.</p>
                            @else
                                <ul>
                                    @foreach ($damagedFacilities as $facility)
                                        <li>{{ $facility->name }} - {{ $facility->fund_source }}</li>
                                    @endforeach
                                </ul>
                            @endif
                        </div>
                ...
                <div class="card-body p-4">
                    <table class="table table-striped table-hover align-middle">
                        ...
                        <tbody>
                            ...
                            @empty
                                <tr>
                                    <td colspan="6" class="text-center text-muted">Tidak ada laporan tersedia.</td>
                                </tr>
                            @endforelse
                        </tbody>
                    </table>
