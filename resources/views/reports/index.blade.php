...
<body>
    ...
    @endif
    <div class="modal" id="reportDetailsModal" tabindex="-1" aria-labelledby="reportDetailsModalLabel"
        aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="reportDetailsModalLabel">Detail Laporan</h5>
            ...
            fetch(`/report/${reportId}/details`)
                ...
                .then(data => {
                    ...
                    if (data.status === 'success' && data.data.length > 0) {
                        ...
                        <p><strong>Updated By:</strong> ${report.updated_by}</p>
