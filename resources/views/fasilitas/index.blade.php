    ...
    <div class="container-fluid py-4">
        <div class="card card-custom shadow-lg border-0">
            <div
                ...
                @can('patch-fasility-permission', Auth::user())
                    ...
                    <table class="table table-hover table-striped table-bordered">
                        <thead class="table-dark">
                            <tr class="text-center">
                                ...
                                <th>Created At</th>
                                <th>Updated At</th>
                                @if (Gate::check('patch-fasility-permission', Auth::user()) || Gate::check('delete-fasility-permission', Auth::user()))
                                    <th>Actions</th>
                                @endif
                            </tr>
                        </thead>
                                    ...
                                    @if (Gate::check('patch-fasility-permission', Auth::user()) || Gate::check('delete-fasility-permission', Auth::user()))
                                        <td class="text-center">
                                            <div class="btn-group" role="group">
                                                ...
                                                @endcan
                                                @can('delete-fasility-permission', Auth::user())
